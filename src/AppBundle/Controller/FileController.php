...
class FileController extends Controller
{
    ...
    public function uploadFile(Request $request)
    {
                ...
                if ( $api->checkApiKey($request->request->get('api_key')) )
                {
                    $path = $this->getParameter('temp_dir');
                    ...
                    if (!is_null($file)) {
                        ...
                        $status = array('status' => "fail", "fileUploaded" => false);
